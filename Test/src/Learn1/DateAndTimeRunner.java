...
public class DateAndTimeRunner {
	...
	public static void main(String[] args) {
		...
		DateTimeFormatter formatter11 = DateTimeFormatter.ofPattern("D");
		DateTimeFormatter formatter12 = DateTimeFormatter.ofPattern("g");
		DateTimeFormatter formatter13 = DateTimeFormatter.ofPattern("w");
		System.out.println("Using function LocaDate " + date.format(formatter1));
		System.out.println("Day of the year " + date.format(formatter11));
		System.out.println("Modified-julian-day " + date.format(formatter12));
		System.out.println("week-of-week-based-year " + date.format(formatter13));
	...
	public static void getCurrentDateTimeWithTimeZone() {
		System.out.println("-----Current Date & time of a different time zone using LocalTime-----");
		ZoneId zoneId = ZoneId.of("Asia/Kolkata");
